...
execute store success score @s CE_resend if score @s CE_current_node matches 1 run scoreboard players set @s CE_suc 1
    ...
    execute if score @s CE_suc matches 1 run tellraw @s [{"text":"Hey you...","color":"white"}]
    execute if score @s CE_suc matches 1 run tellraw @s [{"text":"Yea?","color":"#A8DFFF","clickEvent":{"action":"run_command","value":"/trigger CE_trigger set 5"}}]
