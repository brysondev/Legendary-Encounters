...
execute store success score @s CE_resend if score @s CE_current_node matches 6 run scoreboard players set @s CE_suc 1
    ...
    execute if score @s CE_buy_count matches 2.. run clear @s minecraft:diamond 2
    execute if score @s CE_buy_count matches 2.. run give @s cobblemon:galarica_wreath 1
