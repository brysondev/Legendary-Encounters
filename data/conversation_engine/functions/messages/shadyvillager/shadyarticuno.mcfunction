...
execute store success score @s CE_resend if score @s CE_current_node matches 27 run scoreboard players set @s CE_suc 1
    ...
    execute if score @s CE_buy_count matches 1.. run advancement revoke @s only survivallegends:articuno
