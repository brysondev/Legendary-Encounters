...
execute store success score @s CE_resend if score @s CE_current_node matches 14 run scoreboard players set @s CE_suc 1

    # give the choices
    execute if score @s CE_suc matches 1 run tellraw @s [{"text":"\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n","color":"white"}]
    execute if score @s CE_suc matches 1 run tellraw @s [{"text":"Okay okay- Thanks for listening.","color":"white"}]
    execute if score @s CE_suc matches 1 run function conversation_engine:messages/oldvillager/end
    execute if score @s CE_suc matches 1 run function conversation_engine:messages/oldvillager/end
