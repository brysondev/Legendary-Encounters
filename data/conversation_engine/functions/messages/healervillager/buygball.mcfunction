...
execute store success score @s CE_resend if score @s CE_current_node matches 21 run scoreboard players set @s CE_suc 1
    ...
    execute if score @s CE_buy_count matches 25.. run clear @s minecraft:iron_nugget 25
    execute if score @s CE_buy_count matches 25.. run give @s cobblemon:great_ball 5
