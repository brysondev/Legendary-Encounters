...
scoreboard players set CE_mannager old_villager 0
...
scoreboard players set @s old_villager 0

# try to close the group as well
function conversation_engine:group/close_000

tellraw @s {"text":"[the conversation with Old Villager has ended]","color":"dark_gray"}