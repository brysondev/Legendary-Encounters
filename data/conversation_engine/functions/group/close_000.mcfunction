...
# check all the NPC's
execute if entity @a[scores={healervillager=1}] run scoreboard players set bool CE_suc 1
execute if entity @a[scores={oldvillager=1}] run scoreboard players set bool CE_suc 1
execute if entity @a[scores={shadyvillager=1}] run scoreboard players set bool CE_suc 1
