...
execute if score $shiny temp matches 0 at @p run pokespawnat ~10 ~ ~ walkingwake level=100
execute unless score $shiny temp matches 0 at @p run pokespawnat ~10 ~ ~ walkingwake shiny=yes level=100
